export const profile = {
  ...
  { label: 'Founder', org: 'PrimeICT.lk' },
  { label: 'ICT Tutor', org: 'Education' },
  { label: 'Member', org: 'Computer Society of Sri Lanka' },
  ],
  location: 'Colombo, Sri Lanka',
  availability: 'Open to collaboration & ambitious projects',
  email: 'hello@induwaralakindu.com',
